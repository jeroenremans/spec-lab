...
| Story ID | Title | Epic | Priority | File |
|----------|-------|------|----------|------|
| S1.1 | One-command startup | EP1 | Must-have | [link](EP1_foundation-local-server/story-001.md) |
| S1.2 | Cross-platform compatibility | EP1 | Must-have | [link](EP1_foundation-local-server/story-002.md) |
| S1.3 | Offline-capable frontend | EP1 | Must-have | [link](EP1_foundation-local-server/story-003.md) |
| S2.1 | Add a project | EP2 | Must-have | [link](EP2_multi-project-management/story-001.md) |
| S2.2 | Switch between projects | EP2 | Must-have | [link](EP2_multi-project-management/story-002.md) |
| S2.3 | Persist session across restarts | EP2 | Should-have | [link](EP2_multi-project-management/story-003.md) |
| S3.1 | Browse specs by pipeline phase | EP3 | Must-have | [link](EP3_file-navigation-sidebar/story-001.md) |
| S3.2 | Filter files by status | EP3 | Should-have | [link](EP3_file-navigation-sidebar/story-002.md) |
